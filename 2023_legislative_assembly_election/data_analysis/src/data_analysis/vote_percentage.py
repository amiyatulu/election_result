...
with open('analysis_data/total_votes_by_party_data/total_votes_by_party_data_mizoram.json', 'r') as file:
    data = json.load(file)
...
with open('analysis_data/total_percentage_by_party_data/percentage_mizoram.json', 'w') as file:
